...
def process_video(video_file):
    ...
    # Calculate total progress steps for the whole process
    total_steps = total_frames + len(detected_plates)
        ...
        if current_plate_bbox:
            ...
            for (_, text, prob) in results:
                if prob > 0.5:
                    ...
                    # Draw rectangle only around the number plate area
    ...
    video.release()
    out.release()
    return list(set(detected_plates)), 'output.mp4'
